...
bool GameScene::OnCreate()
{
	...
	CoreEngine::GetInstance()->GetCamera()->SetPosition(glm::vec3(0.0f, 0.0f, 2.0f));
	//CoreEngine::GetInstance()->GetCamera()->SetRotation(-90.0f, 50.0f);
	CoreEngine::GetInstance()->GetCamera()->AddLightSource(new LightSource(glm::vec3(-1.0f, 0.0f, 2.0f), 0.1f, 0.5f, 0.5f, glm::vec3(1.0f, 1.0f, 1.0f)));
	TextureHandler::GetInstance()->CreateTexture("CheckerboardTexture", "./Resources/Textures/Testtexture.png");
